...
class OKXPriceProvider extends ExchangePriceProvider_1.ExchangePriceProvider {
    ...
    fetchPair(pair, abortSignal) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield (0, Utils_1.httpGet)(this.url + "/market/index-tickers?instId=" + pair, this.httpRequestTimeout, abortSignal);
            return parseFloat(response.data[0].idxPx);
        });
    }
    fetchUsdPrice(abortSignal) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield (0, Utils_1.httpGet)(this.url + "/market/index-tickers?instId=BTC-USD", this.httpRequestTimeout, abortSignal);
